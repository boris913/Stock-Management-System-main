...
<center>
    <div class="card shadow mb-4 col-xs-12 col-md-8 border-bottom-primary">
        ...
        <a href="employee.php" type="button" class="btn btn-primary bg-gradient-primary btn-block"> 
            <i class="fas fa-flip-horizontal fa-fw fa-share"></i> Retour 
        </a>
        <div class="card-body">
            <div class="form-group row text-left">
                <div class="col-sm-3 text-primary">
                    <h5>Nom Complet<br></h5>
                </div>
                <div class="col-sm-9">
                    <h5>: <?php echo $i; ?> <?php echo $ii; ?> <br></h5>
                </div>
            </div>
            <div class="form-group row text-left">
                <div class="col-sm-3 text-primary">
            ...
            <div class="form-group row text-left">
                ...
                <div class="col-sm-9">
                    <h5>: <?php echo $g; ?>, <?php echo $f; ?> <br></h5>
                </div>
            </div>
        </div>
    </div>
