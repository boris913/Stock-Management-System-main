...
<div class="card shadow mb-4">
    <div class="card-body">
        <div class="form-group row text-left mb-0">
            <div class="col-sm-9">
                <h5 class="font-weight-bold">Ventes et Inventaire</h5>
            </div>
        ...
        <div class="form-group row text-left mb-0 py-2">
            <div class="col-sm-4 py-1">
                <h6 class="font-weight-bold"><?php echo $fname; ?> <?php echo $lname; ?></h6>
                <h6>Téléphone : <?php echo $pn; ?></h6>
            </div>
            <div class="col-sm-4 py-1"></div>
            <div class="col-sm-4 py-1">
                <h6>Transaction #<?php echo $tid; ?></h6>
                <h6 class="font-weight-bold">Encodeur : <?php echo $role; ?></h6>
...
?>
        ...
        <div class="form-group row text-left mb-0 py-2">
            ...
            <div class="col-sm-4 py-1">
                <h4>Montant en espèces : ₱ <?php echo number_format($cash, 2); ?></h4>
                <table width="100%">
                    <tr>
                    ...
                    <tr>
                        <td class="font-weight-bold">Ajouter la TVA</td>
